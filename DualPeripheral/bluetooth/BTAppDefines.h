...
#define CB_BWAPP_PRODUCT_ID_LIST @[@"abcd"] // if you have more product ID defines
...
#define CMBD_NTF_BW_DICT_KEY_ACTIVITY @"activity"
#define CMBD_NTF_BW_DICT_KEY_ENERGY @"energy"
#define CMBD_NTF_BW_DICT_KEY_STEPS @"steps"
#define CMBD_NTF_BW_DICT_KEY_HISTORY @"history"
#define CMBD_NTF_BW_DICT_KEY_BATTERY @"battery"
#define CMBD_NTF_BW_DICT_KEY_PROD_ID @"prodId"
//#define CMBD_NTF_BW_DICT_KEY_
